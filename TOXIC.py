...
def send_owner_message(message):
    owner_message = "👤 OWNER ID - @TOXICPLAYER002 🎉"
...
def my_info(message):
    ...
    user_info = (
        ...
        f"ŦĦƗS ɃØŦ ØWNɆɌ :- @TOXICPLAYER002"
    )
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet, please purchase from: @TOXICPLAYER002."
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @TOXICPLAYER002 🙇."
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙞𝙨 𝙤𝙣𝙡𝙮 𝙛𝙤𝙧 𝙥𝙖𝙞𝙙 𝙪𝙨𝙚𝙧𝙨 𝙗𝙪𝙮 𝙣𝙤𝙬 𝙛𝙧𝙤𝙢 - @TOXICPLAYER002\n205 KALA JADU "
        bot.reply_to(message, response)
# This File Is Made By @@TOXICPLAYER002
# This File Is Made By @@TOXICPLAYER002
# This File Is Made By @@TOXICPLAYER002
